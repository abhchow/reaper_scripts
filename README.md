...
- The full mix and part missing tracks have a panning arrangement that puts specific parts in specific panning spots. These panning arrangements are only defined for 4, 5, or 6 parts
  ...
  - The panning arrangements can be customised by editing `src/pan_arrangements.yaml` and changing the sequence of numbers in the `positions` of an arrangement. The smaller the number the further left, the larger the number the further right. You can put in any numbers and the script will adjust automatically for you. You can also add arrangements for part counts that aren't listed yet.
